...
# Columns to drop
col_drops = ['Cantidad neta del alimento (Formato texto libre):','Declaración Nutricional:','Variedad:', 'Descripción del rango de raciones:', 'Descripción producto',
             'Descripción:','Modo de empleo:','Peso Neto Escurrido:', 'Propiedades Saludables:']
